    ...
    <div class="form-container d-flex flex-column justify-content-center align-items-center">
        <form action="cadastroAnimalExe.php" method="post">
            <fieldset>
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-auto">
                        <label for="idade" class="col-form-label">Idade do Animal:</label>
                    </div>
                    <div class="col-auto">
                        <input type="number" name="idade" id="idade" class="form-control" aria-describedby="IdadeAnimal" required>
                    </div>
                </div>
